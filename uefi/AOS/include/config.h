 ...
 */
#define UEFI_MEMORY_POOL_PAGES 256

/* 
 * 内存池预分配页数。要求小于总页数，且显然大于0。
 */
#define UEFI_MEMORY_PREALLOCATED_PAGES 8

/* 
 * 强制填充图形界面背景。要求为一个可以表示真假的数值。
 */
#define UEFI_FORCE_FILL_GRAPHICS_BACKGROUND FALSE

/* 
 * 图形界面背景色。要求范围为[0,0xFFFFFF]。
 */
#define UEFI_GRAPHICS_BACKGROUND_COLOR 0x191970
