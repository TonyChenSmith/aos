 ...
 */
#ifndef __AOS_KERNEL_SUPPORT_CONST_H__
#define __AOS_KERNEL_SUPPORT_CONST_H__
...
#define SIZE_4GB   __UINT64_C(0x100000000)
#define SIZE_8GB   __UINT64_C(0x200000000)
#define SIZE_16GB  __UINT64_C(0x400000000)
#define SIZE_32GB  __UINT64_C(0x800000000)
#define SIZE_64GB  __UINT64_C(0x1000000000)
#define SIZE_128GB __UINT64_C(0x2000000000)
#define SIZE_256GB __UINT64_C(0x4000000000)
#define SIZE_512GB __UINT64_C(0x8000000000)
#define SIZE_1TB   __UINT64_C(0x10000000000)
#define SIZE_2TB   __UINT64_C(0x20000000000)
#define SIZE_4TB   __UINT64_C(0x40000000000)
#define SIZE_8TB   __UINT64_C(0x80000000000)
#define SIZE_16TB  __UINT64_C(0x100000000000)
#define SIZE_32TB  __UINT64_C(0x200000000000)
#define SIZE_64TB  __UINT64_C(0x400000000000)
#define SIZE_128TB __UINT64_C(0x800000000000)
#define SIZE_256TB __UINT64_C(0x1000000000000)
#define SIZE_512TB __UINT64_C(0x2000000000000)
#define SIZE_1PB   __UINT64_C(0x4000000000000)
#define SIZE_2PB   __UINT64_C(0x8000000000000)
#define SIZE_4PB   __UINT64_C(0x10000000000000)
#define SIZE_8PB   __UINT64_C(0x20000000000000)
#define SIZE_16PB  __UINT64_C(0x40000000000000)
#define SIZE_32PB  __UINT64_C(0x80000000000000)
#define SIZE_64PB  __UINT64_C(0x100000000000000)
#define SIZE_128PB __UINT64_C(0x200000000000000)
#define SIZE_256PB __UINT64_C(0x400000000000000)
#define SIZE_512PB __UINT64_C(0x800000000000000)
#define SIZE_1EB   __UINT64_C(0x1000000000000000)
#define SIZE_2EB   __UINT64_C(0x2000000000000000)
#define SIZE_4EB   __UINT64_C(0x4000000000000000)
#define SIZE_8EB   __UINT64_C(0x8000000000000000)
